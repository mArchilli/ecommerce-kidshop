        ...
        >
            ...
            <div className="py-6 sm:py-10">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    {/* Buscador */}
                    <div className="mb-6">
                        <div className="bg-gradient-to-r from-white to-yellow-50 rounded-2xl border-4 border-white shadow-lg p-4 sm:p-6">
                            <div className="relative max-w-2xl mx-auto">
                                <input
                                    type="text"
                                    value={searchTerm}
                                    onChange={(e) => setSearchTerm(e.target.value)}
                                    placeholder="🔍 Buscar talle por nombre..."
                                    className="w-full border-2 border-neutral-300 rounded-xl px-4 sm:px-5 py-3 text-sm sm:text-base font-semibold focus:outline-none focus:ring-4 focus:ring-yellow-200 focus:border-yellow-400 pr-10"
                    ...
                    <div className="mb-4">
                        <p className="text-sm sm:text-base font-bold text-gray-700">
                            📊 Mostrando {filteredSizes.length} de {sizes.length} talles
                        </p>
                    </div>
