                ...
                <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl font-bold" style={{ color: '#FFB800' }}>Nuevo Talle</h3>
                            <p className="text-gray-600 mt-2">Crea un nuevo talle para tus productos</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="block w-full rounded-xl border-3 border-gray-300 shadow-sm focus:border-[#FFB800] focus:ring focus:ring-[#FFB800] focus:ring-opacity-50 text-lg p-4"
