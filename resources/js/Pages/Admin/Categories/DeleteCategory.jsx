                ...
                <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-800 mt-2 font-semibold">Estás por eliminar esta categoría permanentemente</p>
                        </div>
                        
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="bg-white rounded-xl p-6 border-3" style={{ borderWidth: '3px', borderColor: '#FC1C1D' }}>
                                <label className="block text-lg font-bold text-gray-800 mb-3">📂 Categoría a eliminar:</label>
                                <input
                                    type="text"
                                    name="name"
                                    value={data.name}
                            ...
                            <div className="bg-yellow-100 border-4 border-yellow-400 rounded-xl p-6">
                                <p className="text-yellow-900 font-bold text-center">
                                    ⚠️ Esta acción no se puede deshacer. Los productos asociados a esta categoría no se eliminarán.
                                </p>
                            </div>
