...
const Pending = ({ cart, user }) => {
  ...
  return (
    <EcommerceLayout>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-16 bg-gradient-to-br from-white via-cyan-50 to-pink-50">
        {/* Icono de pendiente */}
        <div className="bg-gradient-to-br from-cyan-100 to-blue-100 rounded-full p-6 mb-6 flex items-center justify-center shadow-lg">
          <svg className="w-16 h-16 text-cyan-600" fill="none" viewBox="0 0 48 48" stroke="currentColor">
            <circle cx="24" cy="24" r="22" strokeWidth="3" className="text-cyan-300" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M24 14v10l7 7" />
          </svg>
        </div>
        <h1 className="text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent mb-4 text-center">¡Pago pendiente!</h1>
