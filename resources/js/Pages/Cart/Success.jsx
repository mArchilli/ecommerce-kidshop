    ...
    <EcommerceLayout>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-16 bg-gray-50">
        ...
        <div className="bg-green-100 rounded-full p-6 mb-6 flex items-center justify-center">
          <svg className="w-16 h-16 text-green-600" fill="none" viewBox="0 0 48 48" stroke="currentColor">
            <circle cx="24" cy="24" r="22" strokeWidth="3" className="text-green-200" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M16 24l7 7 9-13" />
          </svg>
        </div>
        <h1 className="text-3xl md:text-4xl font-extrabold text-green-700 mb-4 text-center">¡Pago realizado con éxito!</h1>
        ...
        <p className="text-base text-gray-600 mb-8 text-center">
          ...
          Por favor, envíanos el mensaje de WhatsApp para confirmar tu pedido.
        </p>

        {/* Resumen de datos del comprador */}
        <div className="w-full max-w-xl bg-white rounded-lg border border-green-200 p-4 mb-4 text-sm text-gray-700 shadow">
          <h2 className="font-semibold text-green-700 mb-3">Datos del Comprador</h2>
        ...
        {/* Información de envío */}
        <div className="w-full max-w-xl bg-white rounded-lg border border-green-200 p-4 mb-4 text-sm text-gray-700 shadow">
          <h2 className="font-semibold text-green-700 mb-3">Información de Envío</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm">
        ...
        <div className="w-full max-w-xl bg-white rounded-lg border border-green-200 p-4 mb-8 text-sm text-gray-700 shadow">
          ...
          <div className="mt-4 flex justify-end border-t pt-3">
            <span className="text-base font-semibold text-green-700">Total: ${totalFormatted}</span>
          </div>
        </div>
