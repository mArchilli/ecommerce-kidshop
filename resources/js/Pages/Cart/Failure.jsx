    ...
    <EcommerceLayout>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-16 bg-gray-50">
        ...
        <div className="bg-red-100 rounded-full p-6 mb-6 flex items-center justify-center">
          <svg className="w-16 h-16 text-red-600" fill="none" viewBox="0 0 48 48" stroke="currentColor">
            <circle cx="24" cy="24" r="22" strokeWidth="3" className="text-red-200" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M16 16l16 16M32 16L16 32" />
          </svg>
        </div>
        <h1 className="text-3xl md:text-4xl font-extrabold text-red-700 mb-4 text-center">¡El pago ha fallado!</h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full max-w-xs md:max-w-none md:w-auto justify-center">
          ...
          <a
            href="/"
            className="flex items-center justify-center gap-2 bg-gray-500 hover:bg-gray-600 text-white font-semibold px-6 py-3 rounded-md border border-gray-500 transition duration-200"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
