  ...
  return (
    <EcommerceLayout>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-16 bg-gradient-to-br from-white via-pink-50 to-cyan-50">
        {/* Icono de error */}
        <div className="bg-gradient-to-br from-pink-100 to-rose-100 rounded-full p-6 mb-6 flex items-center justify-center shadow-lg">
          <svg className="w-16 h-16 text-rose-600" fill="none" viewBox="0 0 48 48" stroke="currentColor">
            <circle cx="24" cy="24" r="22" strokeWidth="3" className="text-pink-300" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M16 16l16 16M32 16L16 32" />
          </svg>
        </div>
        <h1 className="text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent mb-4 text-center">¡El pago ha fallado!</h1>
        <p className="text-lg text-gray-700 mb-2 text-center">
          Lamentamos informarte que tu pago no se pudo completar.
        </p>
        <p className="text-base text-gray-600 mb-8 text-center">
          Por favor, intenta nuevamente o contáctanos por WhatsApp si el problema persiste.
        </p>
        <div className="flex flex-col md:flex-row gap-4 w-full max-w-xs md:max-w-none md:w-auto justify-center">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
          >
          ...
          <a
            href="/"
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
